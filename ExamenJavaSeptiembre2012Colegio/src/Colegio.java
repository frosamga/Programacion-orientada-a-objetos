...
public class Colegio {
	...
	/*aqui vienen cosas importantes, si es x entonces usas y:
		-Set:  HashSet
	...
	*/
	...
	public Colegio(String nombreFichero) throws IOException {
		//MUY IMPORTANTE, SIEMPRE INICIALIZAR LA LISTA
	...
	/*
	private void leer(Scanner sc) throws IOException {
		String lineaCurso = sc.nextLine();
		while (lineaCurso != null) {
			procesarCurso(lineaCurso,sc);
			lineaCurso = sc.nextLine();
		}
	}
	*/
	...
	//esto es lo que te decia, lee del fichero y para hacerlo mas facil usar un try catch
	//es decir, si falla porque no es como se esperaba, va al catch y hace otra cosa, esta es la manera que
	//quieren que se haga, casi memorizala porque cae seguro
